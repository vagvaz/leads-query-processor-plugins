...
public class GrabbingProxyController extends DefaultProxyController {
     ...
     *                      without proxy)
     */
    public GrabbingProxyController(Collection<? extends String> urlsToGrab, String proxyCheckUrl)
    ...
    public GrabbingProxyController(Collection<? extends URL> urlsToGrab, URL proxyCheckUrl) {
        ...
        log.info("Initializing GrabbingProxyController with " + urlsToGrab.size()
                     + " proxy source urls");
     ...
     */
    private static List<URL> toUrlsList(Collection<? extends String> urls)
        throws MalformedURLException {
