...
yes w | pip2.7 install --user --install-option="--prefix=" -U scikit-learn
# requests package install
yes w | pip2.7 install --user --install-option="--prefix=" -U requests
# lxml package install
sudo apt-get -y install libxslt1-dev libxslt1.1 libxml2-dev libxml2 libssl-dev
yes w | pip2.7 install --user --install-option="--prefix=" -U lxml
# TODO test
