...
def code2tree_v1(code):
    #return content2tree(code)
...
def content2tree(content):
    try:
        return code2tree_v1(content)
    except:
        print sys.exc_info()[0]
        return code2tree_v2(content)
...
def standardizexpath(tree,nodepath,stoppath=''):
    ...
    if parents_w_id != None:
        ...
        for parent in parents_w_id:
            ...
            if stoppath != '' and isancestororself(stoppath,parentpath):
                break
            else:
